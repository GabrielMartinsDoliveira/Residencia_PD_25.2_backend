...
export const createInvestimento = async (req, res) => {
    try {
...
export const getInvestimentos = async (_req, res) => {
    try {
...
export const getInvestimentoById = async (req, res) => {
    try {
...
export const updateStatusInvestimento = async (req, res) => {
    try {
        const investimento = await service.updateStatusInvestimento(req.params.id, req.body.status);
...
export const deleteInvestimentoById = async (req, res) => {
    try {
